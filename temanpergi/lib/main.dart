        ...
        actions: [
          PopupMenuButton(
            ...
            itemBuilder: (context) => [
              ...
              const PopupMenuItem(child: Text('Maps'),value: 2,),
              const PopupMenuItem(child: Text('Places'),value: 3,),
              const PopupMenuItem(child: Text('About'),value: 4,),
            ]
          ),
        ],
      ),
